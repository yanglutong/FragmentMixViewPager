...
public class SaopinAdapterFragment1 extends RecyclerView.Adapter<SaopinAdapterFragment1.ViewHolder> {
    ...
    IDialogSaopin1 dialogSaopin;

    public SaopinAdapterFragment1(SaoPinSetingActivity saoPinSetingActivity) {
        this.context = saoPinSetingActivity;
    }

    public SaopinAdapterFragment1(Context saoPinSetingActivity, List<SaopinBean> spBeanList, IDialogSaopin1 dialogSaopin, String name, List<Integer> numlist) {
        this.context = saoPinSetingActivity;
