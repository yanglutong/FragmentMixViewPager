...
public class SaopinAdapterFragment0 extends RecyclerView.Adapter<SaopinAdapterFragment0.ViewHolder> {
    ...
    public SaopinAdapterFragment0(Context saoPinSetingActivity, List<SaopinBean> spBeanList, IDialogSaopin0 dialogSaopin, String name, List<Integer> numlist) {
        this.context = saoPinSetingActivity;
