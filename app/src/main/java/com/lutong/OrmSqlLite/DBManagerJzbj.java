...
import com.lutong.OrmSqlLite.Bean.JzbJBean;
 ...
 * 封装各种操作数据库的方法
 */
public class DBManagerJzbj {
    private static DBManager dbManager;

    static {
        try {
            dbManager = new DBManager(AppContext.context);
    ...
    public DBManagerJzbj(Context context) throws SQLException {
